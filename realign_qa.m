...
if strcmp(flags.motion_parameters,'on')
    ...
    saveas(gcf, 'motion outlier detection.eps','psc2'); close(gcf)
...
if strcmp(flags.globals,'on')
    ...
    saveas(gcf, 'globals outlier detection.eps','psc2'); close(gcf)
...
if strcmp(flags.volume_distance, 'on')
    ...
    saveas(gcf,'distances.eps','psc2'); close(gcf)
