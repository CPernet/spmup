function [Scaling_Factor]=spm_psc(SPMs,scaling_factor)
        ...
        for c=1:nb_conditions
            ...
            for h=1:length(hrf_param)
                ...
                for l=1:3 % load beta files
                    ...
                    elseif regressors(l)<100
                        name = ['beta_00' num2str(regressors(l)) '.img,1'];
                    elseif regressors(l)<1000
                        name = ['beta_0' num2str(regressors(l)) '.img,1'];
                    else
                        name = ['beta_' num2str(regressors(l)) '.img,1'];
                    end
                ...
                elseif last_column<=100
                    name = ['beta_00' num2str(last_column) '.img,1'];
                elseif last_column<=1000
                    name = ['beta_0' num2str(last_column) '.img,1'];
                else
                    name = ['beta_' num2str(last_column) '.img,1'];
                end
