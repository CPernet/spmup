...
out = spm_get_defaults('images');
if strcmp(out.format,'nii')
    spm_write_filtered(Zth,XYZth,stat_map_vol.dim',stat_map_vol.mat,'thresholded map', strrep(stat_filename,ext, '_pre_topo_thr.nii'));
else
...
if strcmp(out.format,'nii')
    spm_write_filtered(thresholded_Z,thresholded_XYZ,stat_map_vol.dim',stat_map_vol.mat,'thresholded map', strrep(stat_filename,ext, '_thr.nii'));
else
